  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <p className="auth-subtitle">Sign in to continue tailoring your resume.</p>
        ...
        <form id="email-signin-form" className="auth-form" onSubmit={handleEmailLogin}>
        ...
        <Link href="/signup" className="auth-switch">Don&apos;t have an account? Sign up →</Link>
